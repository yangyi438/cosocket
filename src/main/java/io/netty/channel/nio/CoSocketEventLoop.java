 ...
 */
public final class CoSocketEventLoop extends SingleThreadEventLoop {

    private static final InternalLogger logger = InternalLoggerFactory.getInstance(CoSocketEventLoop.class);
    ...
    private final Callable<Integer> pendingTasksCallable = new Callable<Integer>() {
        ...
        public Integer call() throws Exception {
            return CoSocketEventLoop.super.pendingTasks();
        }
    };
            ...
            try {
                ...
                try {
                    ...
                    if (logger.isTraceEnabled()) {
                        logger.trace("then close channel err{}", error);
                    }
                }
            }
        }
