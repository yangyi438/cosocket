...
public final class CoSocketInputStream2 extends InputStream
{

    private final CoSocket2 socket;

    CoSocketInputStream2(CoSocket2 impl) throws IOException {
        assert impl != null;
        socket = impl;
    }
